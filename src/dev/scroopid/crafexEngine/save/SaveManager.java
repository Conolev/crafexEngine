...
/**
 * This class handles the saving of classes within the crafexEngine TODO: Optimize the handling of primitive types,
 * boilerplate code between Arrays and single fields TODO: Check runtime of code TODO: Test
 * 
 * @author jameswomack
 * 
 */
public class SaveManager {
	...
	/**
	 * Saves an ISavable object, saving all field data Method is recursive
	 * 
	 * @param object
	 *        The object to save
	 ...
	 * 
	 * @param object
	 *        The object to save all fields from
	 * @param callsDeep
	 ...
	 * 
	 * @param object
	 *        The object to call the save method
	...
	/**
	 * Adds the SFM to the savableFieldMethods if it doesn't already exist, have the same saving type as another, and as
