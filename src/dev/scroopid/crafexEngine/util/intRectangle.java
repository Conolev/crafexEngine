...
public class intRectangle implements ISavable {
	...
	public intPoint getCornerBottomLeft() {
		...
		double sinTheta = Math.sin(angle);
		int X =
					(int) (cosTheta * (getLeft() - center.getX()) - sinTheta * (getBottom() - center.getY()) + center.getX());
		int Y =
					(int) (sinTheta * (getLeft() - center.getX()) + cosTheta * (getBottom() - center.getY()) + center.getY());
		return new intPoint(X, Y);
	}
	...
	public intPoint getCornerBottomRight() {
		...
		double sinTheta = Math.sin(angle);
		int X =
					(int) (cosTheta * (getRight() - center.getX()) - sinTheta * (getBottom() - center.getY()) + center.getX());
		int Y =
					(int) (sinTheta * (getRight() - center.getX()) + cosTheta * (getBottom() - center.getY()) + center.getY());
		return new intPoint(X, Y);
	}
	...
	public boolean isInside(intPoint point) {
		return Util.isInsidePolygon(point, new intPoint[] { getCornerTopLeft(), getCornerTopRight(),
	...
	public boolean isInside(floatPoint point) {
		return Util.isInsidePolygon(point.toIntPoint(), new intPoint[] { getCornerTopLeft(), getCornerTopRight(),
					getCornerBottomRight(), getCornerBottomLeft() });
	}
