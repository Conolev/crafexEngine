...
public class floatRectangle implements ISavable {
	...
	public floatPoint getCornerTopLeft(){
		...
		float X = (float) (cosTheta * (getLeft() - center.getX()) - sinTheta * (getTop() - center.getY()) + center.getX());
		float Y = (float) (sinTheta * (getLeft() - center.getX()) + cosTheta * (getTop() - center.getY()) + center.getY());
	...
	public floatPoint getCornerTopRight(){
		...
		double cosTheta = Math.cos(angle);
		double sinTheta = Math.sin(angle);
		float X = (float) (cosTheta * (getRight() - center.getX()) - sinTheta * (getTop() - center.getY()) + center.getX());
		float Y = (float) (sinTheta * (getRight() - center.getX()) + cosTheta * (getTop() - center.getY()) + center.getY());
		return new floatPoint(X, Y);
	}
	...
	public floatPoint getCornerBottomLeft(){
		...
		double cosTheta = Math.cos(angle);
		double sinTheta = Math.sin(angle);
		float X = (float) (cosTheta * (getLeft() - center.getX()) - sinTheta * (getBottom() - center.getY()) + center.getX());
		float Y = (float) (sinTheta * (getLeft() - center.getX()) + cosTheta * (getBottom() - center.getY()) + center.getY());
		return new floatPoint(X, Y);
	}
	...
	public floatPoint getCornerBottomRight(){
		...
		double cosTheta = Math.cos(angle);
		double sinTheta = Math.sin(angle);
		float X = (float) (cosTheta * (getRight() - center.getX()) - sinTheta * (getBottom() - center.getY()) + center.getX());
		float Y = (float) (sinTheta * (getRight() - center.getX()) + cosTheta * (getBottom() - center.getY()) + center.getY());
		return new floatPoint(X, Y);
	}
	...
	public boolean isInside(intPoint point){
		return Util.isInsidePolygon(point.toFloatPoint(), new floatPoint[]{
	...
	public boolean isInside(floatPoint point){
		return Util.isInsidePolygon(point, new floatPoint[]{
					getCornerTopLeft(), getCornerTopRight(), 
					getCornerBottomRight(), getCornerBottomLeft()
		});
	}
